        ...
        <div className="resumePageSty">
            ...
            <Grid container>
                <Grid xs={12} md={12} className="dwnLoadStyle">
                    <DownloadIcon sx={{mr: 1, ml: 3, fontSize: '20px', color: 'white'}}/>
            ...
            <div className="paperStyle">
                <Grid container>
                    ...
                    <Grid xs={12} md={9} className="txt-aln">
                        ...
                        <p className="textDvcSty">Expert Frontend developer and UX Engineer.</p>
                        <p className="textDvcSty"><EmailIcon
                            sx={{mr: 1, ml: 1, cursor: 'pointer', verticalAlign: 'middle'}}/>{userDetails.email}</p>
                        <p className="textDvcSty"><PhoneIcon
                            sx={{mr: 1, ml: 1, cursor: 'pointer', verticalAlign: 'middle'}}/>{userDetails.phone}</p>
                    </Grid>
                    <Grid xs={12} md={3}>
