            ...
            <Grid container>
                <Grid xs={3} md={6}>
                    <Toolbar disableGutters sx={{paddingTop: 0.5}}>
                        <DevicesIcon onClick={() => navigateToRouteProvided('/')}
                                     sx={{mr: 1, ml: 1, cursor: 'pointer'}}/>
                        <TerrainIcon onClick={redirectToInstagram} sx={{mr: 1, ml: 2, cursor: 'pointer'}}/>
                    </Toolbar>
                </Grid>
                <Grid xs={9} md={6}>
                    <Box sx={{flexGrow: 1, display: {xs: 'flex', md: 'flex'}, float: 'right', mr: 7}}>
                        <Button
                            sx={{my: 2, color: 'white', display: 'block'}}
                            onClick={() => navigateToRouteProvided('/projects')}
                        >
                            Projects
                        </Button>
                        <Button
